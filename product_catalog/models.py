...
class Car(models.Model):
    ...
    mileage = models.PositiveIntegerField()  # Consider changing to models.PositiveIntegerField() to handle kilometers
    ...
    price = models.DecimalField(max_digits=15, decimal_places=2)  # Adjust as needed
